...
#include "miryoku_layer_alternatives.h"
	...
	#elif defined (MIRYOKU_ALPHAS_CANARY)
	  #define MIRYOKU_LAYER_BASE MIRYKU_ALTERNATIVES_BASE_CANARY
    #elif defined (MIRYOKU_ALPHAS_COLEMAK)
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
	...
	#elif defined (MIRYOKU_EXTRA_CANARY)
	  #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_CANARY
    #elif defined (MIRYOKU_EXTRA_COLEMAK)
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
	...
	#elif defined (MIRYOKU_TAP_CANARY)
	  #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_CANARY
    #elif defined (MIRYOKU_TAP_COLEMAK)
